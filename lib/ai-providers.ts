    ...
    fields: [
      {
        ...
        required: false,
        description:
          "Google Cloud Service Account JSON Key. If empty, will try to use your Gemini API key.",
        sensitive: true,
      },
    ],
    notes:
      "Uses your existing Gemini API key (Google Cloud Service Account) if available and compatible, or you can provide a specific key here.",
    models: {
      transcription: [
        {
          id: "chirp_3",
