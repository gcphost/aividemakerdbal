...
export type ProcessType = "image-generation" | "ai-call" | "audio-generation" | "video-compilation" | "video-generation" | "video-generation-ai" | "video-extension-ai" | "timeline-generation" | "chunked-timeline-generation" | "thumbnail-generation" | "music-generation" | "sound-generation" | "description-generation" | "content-generation" | "profile-generation" | "chapter-generation" | "script-generation" | "chunked-script-generation" | "video-creation" | "audio-timeline" | "audio-timeline-generation" | "narration-chunk" | "bulk-script-generation" | "bulk-audio-generation" | "bulk-image-generation" | "bulk-music-generation" | "bulk-sound-generation" | "bulk-video-generation" | "auto-generate-all-content" | "attachment-image-analysis" | "attachment-audio-analysis" | "attachment-video-analysis" | "audio-transcribe";
